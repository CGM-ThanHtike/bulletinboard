...
Route::middleware(['auth'])->group(function () {
  ...
  Route::get('/posts/csv', [PostsController::class, 'csv'])->name('posts.csv');
  Route::post('/posts/csv/csv-upload', [PostsController::class, 'uploadPostsCsv'])->name('posts.csv-upload');
});
