                ...
                <div class="card-body">
                    ...
                    {{-- <form method="POST" action="none"> --}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select" aria-label="" name="role" >
                                    <option @if(Auth::user()->role == '2')selected @endif value="2">User</option>
                                    <option @if(Auth::user()->role == '1')selected @endif value="1">Admin</option>
                                </select>
                            </div>
                        </div>
                        ...
                        {{-- <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="text" class="form-control" value="{{$user->password}}" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div> --}}
